...
var todoItems = [{
    name: 'Hug Taylor Swift',
    completed: false
},{
    name: 'Buy Red Ferrari Car',
    completed: false
}, {
    name: 'Hired in Big Company',
    completed: false
}];
...
var AddItem = function (_React$Component2) {
    ...
    AddItem.prototype.render = function render() {
        return React.createElement(
            ...
            React.createElement('input', { className: 'add-item-input', type: 'text', placeholder: 'Type something nice :-)', ref: 'newItem' }),
